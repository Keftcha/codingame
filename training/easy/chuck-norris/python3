...
# On converti les caractère en binare et on les met dans une liste
for lettre in message:
        liste_message.append(bin(ord(lettre)))


# On enlève le 0b devant les nombres binaires
...
def changement_idx(liste):
    "Fonction qui donne l'endroit où il y a les changement entre les 0 et les
1"
...
print(chaine_resultat, file=sys.stderr)
